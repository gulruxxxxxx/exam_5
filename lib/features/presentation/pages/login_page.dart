...
import 'package:productivee/features/presentation/pages/profile_page.dart';
import 'package:productivee/features/presentation/pages/sign_up_page.dart';
                 ...
                 WButton(
                    ...
                    onTap: () async {
                      try {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  ProfilePage(user: auth.currentUser!,)),
                        );
                      } catch (e) {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: const Text(
                "Sign up",
                style: TextStyle(fontSize: 15, color: textButtonColor),
              ),
            ),
          ),
        ],
